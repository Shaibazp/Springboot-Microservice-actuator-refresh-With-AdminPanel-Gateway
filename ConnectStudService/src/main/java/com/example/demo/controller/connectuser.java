...
public interface connectuser 
{
	...
	public ResponseEntity<String> produpdate(@RequestBody Product pid);
	
	@PatchMapping("/prod/submodi/{sid}/{sstd}")
	public ResponseEntity<String> produpdateSub(@PathVariable Integer sid, @PathVariable String sstd);
}
